...
interface DropzoneProps {
	...
	onFileRemoved: (file: File) => void; // New prop for handling file removal
	maxFiles?: number;
	maxSize?: number;
...
export default function Dropzone({
	onFilesAdded,
	onFileRemoved, // Add the new prop
	maxFiles = 5,
	...
	const removeFile = (file: FileWithPreview) => {
		...
		onFileRemoved(file); // Notify parent component about removed file
	};
		...
		<>
			...
			>
				...
				<p className='text-muted-foreground mb-2 text-center text-sm'>
					<span className='font-semibold'>Clique para fazer upload</span> ou arraste uma foto
				</p>
